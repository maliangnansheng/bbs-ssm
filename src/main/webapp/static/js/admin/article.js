        ...
        success: function (data) {
            ...
            for (var i=0;i<listArticles.length;i++){
                ...
                listArticle_all = listArticle_all +
                    ...
                    '</td>' +
                    '<td width="300px">' +
                    '<div style="width:300px;word-wrap:break-word;"><a href="javascript:void(0);" onclick="skipArticle('+listArticle["fid"]+')" data-toggle="modal" data-target="#adminArticle">'+listArticle["titles"]+'</a></div>' +
                    '</td>' +
